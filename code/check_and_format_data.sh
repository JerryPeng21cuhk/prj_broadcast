...
perl -CSAD code/gen_wavscp.pl $opath2dir/wav.list > $opath2dir/wav_org.scp
...
echo "Note that some audio in $opath2dir/wav.list may not have\
 the presumed format in code/gen_wavscp.pl. And they are discarded from $opath2dir/wav_org.scp"
...
# 44.1k to 16k
# mp3 to wav
perl -CSAD code/cvt_wavformat.pl $opath2dir/wav_org.scp > $opath2dir/wav_cvt.scp
