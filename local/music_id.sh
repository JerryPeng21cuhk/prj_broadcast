...
#  Revised     2018  Jerry Peng

# Apache 2.0.

# This script calculates the relative probability of music (or noise) versus
# speech.
...
if [ $stage -le 0 ]; then
  $cmd JOB=1:$nj $dir/log/get_music_logprob.JOB.log \
    fgmm-global-get-frame-likes --average=$average \
...
#    >$dir/logprob || exit 1;
#
#  # ratio indicates the p(music | segment) / p(speech | segment) without prior
#  cat $dir/logprob | \
